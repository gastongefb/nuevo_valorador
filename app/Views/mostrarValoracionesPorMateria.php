...
<h2 class="text-center text-primary fw-bold">Listado de Valoraciones de la materia: <?php echo htmlspecialchars($materia); ?></h2>
...
<form method="post" action="<?= site_url('pdf/generatePdfPorMateria') ?>" style="display:none;" id="pdfForm">
